...
package/%.xdc.inc package/%_xconfig_AS3.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_AS3" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: AS3.pem4f

-include package/cfg/AS3_pem4f.mak
-include package/cfg/AS3_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/AS3_pem4f.dep
endif
AS3.pem4f: package/cfg/AS3_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
AS3.pem4f package/cfg/AS3_pem4f.c: .libraries,em4f
endif

package/cfg/AS3_pem4f.c package/cfg/AS3_pem4f.h package/cfg/AS3_pem4f.xdl: override _PROG_NAME := AS3.xem4f
package/cfg/AS3_pem4f.c: package/cfg/AS3_pem4f.cfg
package/cfg/AS3_pem4f.xdc.inc: package/cfg/AS3_pem4f.xdl
package/cfg/AS3_pem4f.xdl package/cfg/AS3_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/AS3_pem4f.cfg
	-$(RM) package/cfg/AS3_pem4f.dep
	-$(RM) package/cfg/AS3_pem4f.c
	-$(RM) package/cfg/AS3_pem4f.xdc.inc

clean,em4f::
	-$(RM) AS3.pem4f
.executables,em4f .executables: AS3.xem4f

AS3.xem4f: |AS3.pem4f

-include package/cfg/AS3.xem4f.mak
AS3.xem4f: package/cfg/AS3_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/AS3_pem4f.oem4f   package/cfg/AS3_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
AS3.xem4f: export C_DIR=
AS3.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
AS3.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

AS3.test test,em4f test: AS3.xem4f.test

AS3.xem4f.test:: AS3.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 AS3.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.AS3.xem4f, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
AS3_pem4f.oem4f,copy : package/cfg/AS3_pem4f.oem4f
AS3_pem4f.sem4f,copy : package/cfg/AS3_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_AS3
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_AS3.tar.dep
endif
package/rel/xconfig_AS3/xconfig_AS3/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_AS3/xconfig_AS3/package/package.rel.xml: package/build.cfg
package/rel/xconfig_AS3/xconfig_AS3/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_AS3/xconfig_AS3/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_AS3.tar: package/rel/xconfig_AS3.xdc.inc package/rel/xconfig_AS3/xconfig_AS3/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_AS3.xdc.inc,package/rel/xconfig_AS3.tar.dep)


release release,xconfig_AS3: all xconfig_AS3.tar
clean:: .clean
	-$(RM) xconfig_AS3.tar
	-$(RM) package/rel/xconfig_AS3.xdc.inc
	-$(RM) package/rel/xconfig_AS3.tar.dep
